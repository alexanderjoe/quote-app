<div>
    <form wire:submit.prevent="addQuote">
        <div class="mb-4">
            <div class="mb-2">
                <label for="quote" class="block mb-2 text-sm font-medium text-white">Add a quote</label>
        ...
        <div class="text-white flex justify-start items-center">
            ...
            <div class="inline-flex items-center ml-2" wire:loading.inline-flex wire:target="addQuote">
                <div role="status">
                    <svg aria-hidden="true" class="mr-2 w-8 h-8 animate-spin text-gray-600 fill-blue-600"
